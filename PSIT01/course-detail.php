...
$discount = 0;
if ($current_course['original_price'] > $current_course['price']) {
    $discount = round((($current_course['original_price'] - $current_course['price']) / $current_course['original_price']) * 100);
}
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2">
                ...
                <!-- Category Badge -->
                <span class="inline-block bg-white text-primary px-4 py-1 rounded-full text-sm font-semibold mb-4">
            ...
            <div class="lg:col-span-1">
                <div class="bg-white text-gray-800 rounded-lg shadow-xl p-6 lg:sticky lg:top-20">
                    ...
                    <!-- Enroll Button -->
                    <button class="w-full bg-primary text-white py-3 rounded-lg font-semibold hover:bg-indigo-700 transition mb-3">
        ...
        <div class="grid grid-cols-1 lg: grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2">
                ...
                <div class="bg-white rounded-lg shadow-md overflow-hidden mb-6">
                    <div class="flex border-b">
                        <button class="tab-button active px-6 py-4 font-semibold text-primary border-b-2 border-primary" data-tab="overview">
                            Overview
                        </button>
                        <button class="tab-button px-6 py-4 font-semibold text-gray-600 hover:text-primary" data-tab="curriculum">
                            Curriculum
                        </button>
                        <button class="tab-button px-6 py-4 font-semibold text-gray-600 hover:text-primary" data-tab="reviews">
                            Reviews
                        </button>
                    </div>
            ...
            <div class="lg:col-span-1">
                ...
                <div class="bg-white rounded-lg shadow-md p-6">
                    ...
                    <div class="space-y-4">
                        <?php
                        // Get 3 random courses from the same category
                        $related = getCoursesByCategory($courses, $current_course['category']);
                        $related = array_filter($related, function($c) use ($course_id) {
                        ...
                        ?>
                            <a href="course-detail.php?id=<?php echo $related_course['id']; ?>" class="block hover:bg-gray-50 p-2 rounded transition">
                                <div class="flex gap-3">
                                    <img src="<?php echo $related_course['image']; ?>" 
                                         alt="<?php echo $related_course['title']; ?>" 
                                         class="w-20 h-20 object-cover rounded">
                                    <div class="flex-1">
                                        <h4 class="font-semibold text-sm mb-1 line-clamp-2">
                                            <?php echo $related_course['title']; ?>
                                        </h4>
                                        <p class="text-xs text-gray-600 mb-1"><?php echo $related_course['instructor']; ?></p>
